...
public class LoadIncrementalHFiles extends Configured implements Tool {
   ...
   * @throws org.apache.hadoop.hbase.TableNotFoundException if table does not yet exist
   */
  ...
  /**
   * @deprecated Use {@link #tryAtomicRegionLoad(org.apache.hadoop.hbase.client.HConnection, org.apache.hadoop.hbase.TableName, byte[], java.util.Collection)}
   */
  @Deprecated
  ...
  throws IOException {
    ...
    try {
      ...
      for (Entry<byte[],byte[]> entry : fileInfo.entrySet()) {
