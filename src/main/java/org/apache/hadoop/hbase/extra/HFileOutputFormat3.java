package org.apache.hadoop.hbase.extra;

/**
 * Created by euleli on 2015/9/10.
 */
...
public class HFileOutputFormat3
    ...
    // HFileOutputFormat3 to internally transfer data between job setup and
     ...
     *   <li>Sets the output key/value class to match HFileOutputFormat3's requirements</li>
    ...
    public static void configureIncrementalLoad(Job job, HTable table)
            throws IOException {
        configureIncrementalLoad(job, table, HFileOutputFormat3.class);
    }
     ...
     */
    @VisibleForTesting
    public static Map<byte[], Algorithm> createFamilyCompressionMap(Configuration
                                                                            conf) {
     ...
     */
    @VisibleForTesting
    public static Map<byte[], BloomType> createFamilyBloomTypeMap(Configuration conf) {
        Map<byte[], String> stringMap = createFamilyConfValueMap(conf,
     ...
     */
    @VisibleForTesting
    public static Map<byte[], Integer> createFamilyBlockSizeMap(Configuration conf) {
        Map<byte[], String> stringMap = createFamilyConfValueMap(conf,
