...
public interface RowProcessor<S extends Message, T extends Message> {
   ...
   * the {@link #initialize(com.google.protobuf.Message msg)} method. If there is no RowProcessor
  ...
  /**
   * @return The {@link org.apache.hadoop.hbase.client.Durability} to use
   */
